...
import pytest
import yaml
from iplan_hermes.ledger.persistence import load
from iplan_hermes.relay import store as relay_store
from iplan_hermes.relay.client import IplanicClient
...
def _drain(endpoint_client: IplanicClient, store: Path, **kw: Any) -> Any:
    from iplan_hermes.relay.worker import drain
