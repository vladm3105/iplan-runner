...
import pytest
import yaml
from iplan_hermes.monitoring.alerts import build_issue, evaluate_alerts
from iplan_hermes.monitoring.probes import probe_server
...
def test_provider_record_does_not_raise() -> None:
    ...
    from iplan_hermes.monitoring.otel import get_provider

    provider = get_provider("iplan-hermes")
